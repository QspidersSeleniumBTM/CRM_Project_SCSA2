...
public class SalesOrderModulePage {
	...
	@FindBy(name="property(Due Date)") private WebElement dueDateTb;

	public WebElement getDueDateTb() {
		return dueDateTb;
	}

	public void setDueDateTb(String dd) {
		dueDateTb.sendKeys(dd);
	}

	public SalesOrderModulePage(WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath="//a[.='Hp laptop']") private WebElement qut;
